...
import TransactionHistory from "../../../clinicDashboard/Billing/TransactionHistory/TransactionHistory";
      ...
      >
        <div className={styles.dashboard_sub_conatiner}>
          <div className={styles.dashSub_blue}>
            ...
            <div className={styles.compo_name1}>
              <span>user account information</span>
            </div>
            <div className={styles.compo_name_text}>
              <div>
                <h5>Full Name</h5>
                <h6>Dr Johan Smith</h6>
              </div>
              <div>
                <h5>Email</h5>
                <h6>johan@smith.com</h6>
              </div>
              <div>
                <h5>Phone Number</h5>
                <h6>+1-907-555-1234</h6>
              </div>
            </div>
            <hr></hr>
            <div className={styles.compo_name}>
