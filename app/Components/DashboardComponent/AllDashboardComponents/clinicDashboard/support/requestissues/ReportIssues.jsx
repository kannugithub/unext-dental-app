...
const ReportIssues = () => {
  ...
  return (
    <>
      ...
      >
        <div className={styles.mobile_number_head}>Report Issue</div>
            ...
            <div className="card-body">
              <div className={styles.sentfax_container}>
                <div className={styles.sentMobile_left}>
                  <div className={styles.mobile_number_txt}>Enter Issue</div>
                  ...
                  <div className={styles.img_upload_box}>
                    <div className={styles.img_boxes}>
                      <textarea
                        name="description"
                        placeholder="Provide clear details of the issue encountered, including steps to reproduce and any relevant information. Your input helps improve our product"
