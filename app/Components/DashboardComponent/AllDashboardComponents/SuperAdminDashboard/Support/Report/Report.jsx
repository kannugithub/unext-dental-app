...
import { fetchSupportReport } from "@/app/store/slices/superAdminSlices";
...
function Report() {
  ...
  const getSupportList = useAppSelector((state) => state.admin.getReportdata);
  ...
  useEffect(() => {
    const fetchData = async () => {
      setDataLoading(true);
      try {
        const data = await dispatch(fetchSupportReport({ currentPage, limit }));
