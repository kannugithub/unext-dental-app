...
import styles from "./requestfeature.module.scss";
...
import { fetchSupportRequestFeatures } from "@/app/store/slices/superAdminSlices";
...
import CouponDelete from "../../../CommonComponent/CouponIdDelete/CouponDelete";
...
function RequestFeature() {
  ...
  const getSupportList = useAppSelector(
    (state) => state.admin.getRequestFeaturesdata
  );
    ...
    const fetchData = async () => {
      ...
      try {
        const data = await dispatch(
          fetchSupportRequestFeatures({ currentPage, limit })
        );
