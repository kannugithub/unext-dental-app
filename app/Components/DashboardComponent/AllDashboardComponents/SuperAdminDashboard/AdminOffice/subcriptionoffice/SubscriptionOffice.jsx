...
import styles from "./subsciptionoffice.module.scss";
...
import { Row, Form, Col, FormSelect, Button } from "react-bootstrap";
...
export const SubscriptionOffice = ({
  closeOfficepopup,
        ...
        <div className={styles.subscription_plan}>
          ...
          <div className="container">
            ...
            <div className={styles.payMonthly}>
              Fill in your credentials and click on the the Enroll button
            </div>
...
export default SubscriptionOffice;
