...
import styles from "../setOfficeHours/setofficehours.module.scss";

const DefaultMessagesPopup = ({ handleCloseDefmessage }) => {
  return (
    <div className={styles.SetOfficeHours_wrapper}>
      <svg
        onClick={() => handleCloseDefmessage(false)}
      ...
      <div className={styles.main_wrapper}>
        <div className={styles.headline}>
          <h1>Set Default Message</h1>
        </div>
        <div className={styles.form_box_time}>
          <div className={styles.timebox} style={{ width: "100%" }}>
        ...
        <div className={styles.Button_wrappr}>
          ...
          <div className={styles.cn_btn}>
            <button onClick={() => handleCloseDefmessage(false)}>Cancel</button>
          </div>
        </div>
      </div>
    </div>
...
export default DefaultMessagesPopup;
